...
<!-- 
<a href="https://github.com/MitchMedeiros/MLCopmare/actions/workflows/test.yml">
    <img alt="GitHub Actions build status (Test Linux and macOS)" src="https://github.com/MitchMedeiros/MLCompare/workflows/Test/badge.svg">
</a>
...
MLCompare is a Python library for running comparison pipelines. It supports multiple popular ML libraries plus user defined models, performs dataset retrieve and processing, and . What makes MLCompare stand out from other libraries and frameworks is how easy it is to use while maintaining flexibility.

<table align="center">
    <tr>
        <th><div align="center">Libraries</div></th>
        <th><div align="center">Datasets</div></th>
        <th><div align="center">Columnar Data Processing</div></th>
    </tr>
    <tr>
        <td>
            <ul>
