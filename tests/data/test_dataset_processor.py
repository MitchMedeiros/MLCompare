...
from mlc import DatasetProcessor
...
#         processor = DatasetProcessor(default_save_path=save_path)
...
#         with self.assertRaises(ValueError):
#             DatasetProcessor(data=data_path)
...
#         processor = DatasetProcessor(default_save_path=None)
...
#             DatasetProcessor(data=Path("data/test.txt"))
#         self.assertTrue(
...
#         mixed_data = 123
#         processor = DatasetProcessor(data=mixed_data)
